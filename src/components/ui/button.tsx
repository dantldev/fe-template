    ...
    return (
      <TooltipProvider>
        <Tooltip delayDuration={100} {...tooltipProps}>
          ...
          <TooltipContent side="right" {...tooltipContentProps}>
            <p className="ml-2 text-sm bg-white dark:bg-black py-2 px-4 rounded-md animate-in fade-in-0 slide-in-from-right-4">{tooltip}</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    )
